...
export class FriendsService {
    ...
    getPendingInvites(userUid: string): Observable<{ [friendUid: string]: { displayName: string, invite: true } }> {
        return this.db.object<{ [friendUid: string]: { displayName: string, invite: true } }>(`pendingFriendInvite/${userUid}`).valueChanges();
    }

    getUserFriend(friendUid: string): Observable<User> {
