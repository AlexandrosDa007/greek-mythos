...
import { objectKVs } from 'functions/src/helpers/object-keys-values';
...
export class GameService {
  ...
  async rollDice(uid: string, game: Game): Promise<number> {
  ...
  gameInvites(): Observable<Record<string, { dn: string, roomId: string, roomName: string, accept: boolean }>> {
  ...
  pendingGameInvites(): Observable<Record<string, { dn: string, roomId: string, roomName: string, accept: boolean }>> {
