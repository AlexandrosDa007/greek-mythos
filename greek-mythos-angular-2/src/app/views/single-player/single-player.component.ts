...
import { getNumberFromZeroToX } from '@app/helpers/get-number-zero-to-x';
import { halveAnswers } from '@app/helpers/half-answers';
import { getSpiralFormOfArray } from '@app/helpers/matrix';
import { objectKeys, objectValues } from '@app/helpers/object-keys-values';
import { Board, Player } from '@app/models/board';
import { Game, GameEvent, GameQuestion } from '@app/models/game';
import { Settings } from '@app/models/settings';
import { User } from '@app/models/user';
import { AudioService } from '@app/services/audio.service';
import { AuthService } from '@app/services/auth.service';
import { QuestionService } from '@app/services/question.service';
import { SinglePlayerService } from '@app/services/single-player.service';
import { TimerService } from '@app/services/timer.service';
import { EVENTS_MAP_BIG, EVENTS_MAP_SMALL, HELPS, QUESTIONS_MAP_BIG, QUESTIONS_MAP_SMALL } from '@env/environment';
...
export class SinglePlayerComponent implements OnInit, OnDestroy {
  ...
  async removeFiveSecondTimer(): Promise<void> {
    ...
    this.activeGameEvent = undefined;
    this.isMyGameEvent = false;
